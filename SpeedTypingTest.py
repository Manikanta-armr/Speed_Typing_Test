...
label1=Label(master=window,text="Here is your Sentence:",bg="skyblue",font=("Times", "12", "bold italic"))
label1.place(x=15,y=10)

text1=Text(master=window,height=4,width=42,)
text1.place(x=15,y=40)

label2=Label(master=window,text="Type the above Sentence:",bg="skyblue",font=("Times", "12", "bold italic"))
label2.place(x=15,y=120)

text2=Text(master=window,height=4,width=42,)
text2.place(x=15,y=150)

button=Button(master=window,text="Check Result",bg="lightgreen",font=("Times", "10", "bold italic"),relief="raised",command=lambda:calculate(time.time()))
button.place(x=140,y=230)

label3=Label(master=window,text="Results:",bg="skyblue",font=("Times", "12", "bold italic"))
label3.place(x=15,y=260)

text3=Text(master=window,height=6,width=42,)
text3.place(x=15,y=285)

reset_button=Button(master=window,text=" RESET ",width=10,bg="orange",font=("Times", "10", "bold italic"),relief="raised",command=lambda:reset())
